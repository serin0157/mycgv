 ...
 ********************************************/
	$("#cpass").on("blur",function(){
		if($("#pass").val() !="" && $("#cpass").val() !=""){
			$("cmsg").text("비밀번호가 동일합니다").css("color","blue").css("font-size","11pt").css("display","block");
			$("#name").focus();
		}else{
			$("cmsg").text("비밀번호가 동일하지 않습니다.  다시 입력해주세요").css("color","red")
 ...
 ******************************/
	$("#btnJoin").click(function(){
		...
		if($("#id").val()==""){
			...
			alert("주소를 입력해주세요")
			$("#btnSearch").css("border", "1px solid gray");
			return false;
		}else if($("#addr2").val()==""){
			alert("상세주소를 입력해주세요")
			$("#addr2").focus();
